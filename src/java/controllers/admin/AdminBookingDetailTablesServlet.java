 ...
 * @author letra
 */
public class AdminBookingDetailTablesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminBookingDetailTablesServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminBookingDetailTablesServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (listBookingDetailDTO != null) {
            for (BookingDetailDTO bookingDetailDTO : listBookingDetailDTO) {
                if (bookingDetailDTO.getBooking().getBookingStatus().equals("paid")) {
                    totalPrice += bookingDetailDTO.getPrice();
                }
            }
        }
        ...
        request.getRequestDispatcher("AdminBookingDetailTables.jsp").forward(request, response);
    }
