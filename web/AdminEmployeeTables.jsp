...
<html lang="en">
    ...
    <body id="page-top">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody id="employeeFound">
                                            ...
                                            <c:forEach var="employee" items="${employeeList}">
                                                ...
                                                <tr>
                                                    ...
                                                    <c:if test="${employee.status =='enable'}">
                                                        <td class="text-center"><button type="button" class="btn btn-danger w-75" data-bs-toggle="modal" data-bs-target="#disableEmployee${employee.employeeUsername}">Disable</button></td>

                                                    </c:if>
                                                    <c:if test="${employee.status =='disable'}">
                                                        <td class="text-center"><button type="button" class="btn btn-success w-75" data-bs-toggle="modal" data-bs-target="#enableEmployee${employee.employeeUsername}">Enable</button></td>
                                    ...
                                    <nav aria-label="" style="margin-top: 35px;">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <c:if test="${page != 1}">
                                                <li class="page-item">
                                                    <a class="page-link" href="AdminEmployeeTablesServlet?page=${page-1}">Previous</a>
                                                </li>
                                            </c:if>
                                            <c:if test="${page == 1}">
                                            ...
                                            <c:forEach var="i" begin="1" end="${endPage}">
                                                <c:if test="${page == i}">
                                                    <li class="page-item active">
                                                        <a class="page-link" href="AdminEmployeeTablesServlet?page=${i}">${i}</a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${page != i}">
                                                    <li class="page-item ">
                                            ...
                                            <c:if test="${endPage != page}">
                                                <li class="page-item">
                                                    <a class="page-link" href="AdminEmployeeTablesServlet?page=${page+1}">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</a>
                                                </li>
                                            </c:if>
                                            <c:if test="${endPage == page}">
                                                <li class="page-item disabled">
                    ...
                    <div class="modal-body" style="padding: 0;">
                        <div class="wrapper" >
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="inner">
                                        <form action="AdminRegisterEmployeeServlet" method="POST">
                                            <h3 style="margin-bottom: 10px">Add Employee</h3>
        ...
        <c:forEach items="${employeeListFull}" var="employee">
            <c:if test="${employee.status == 'enable'}">
                <div class="modal fade" id="disableEmployee${employee.employeeUsername}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Make sure you want to Disable</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                Press "Disable" to make you want to disable employee: "${employee.employeeUsername}"
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-danger" onclick="window.location = 'AdminDisableEmployeeServlet?employeeUsername=${employee.employeeUsername}'">Disable</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <c:if test="${employee.status == 'disable'}">
                <div class="modal fade" id="enableEmployee${employee.employeeUsername}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Make sure you want to enable</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                Press "Enable" to make you want to Enable employee: "${employee.employeeUsername}"
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-success" onclick="window.location = 'AdminEnableEmployeeServlet?employeeUsername=${employee.employeeUsername}'">Enable</button>
                            </div>
                        </div>
                    </div>
                </div>
