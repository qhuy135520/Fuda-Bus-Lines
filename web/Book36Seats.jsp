...
<html>
    ...
    <body>
        ...
        <div class="background">
            <div class="container-md">
                ...
                <div class="route-option-36seats">
                    <form autocomplete="off" onsubmit="return handleData()"  onsubmit="() => init()" action="TakeSeatServlet" method="POST" >
                        <div class="card ">
                            <div class="card-header d-flex justify-content-between">
                                <div>
                                    <h4> ${sessionScope.tripDetail.departureTime}
                                        ...
                                        <span> Price: ${sessionScope.tripDetail.ticketPrice}vnd</span></h4>
                                </div>
                                <div>
                                ...
                                <div class="tab-pane fade show active" id="nav-profile-36" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    <div class="bus">
                                        ...
                                        <c:forEach var="i" begin="0" end="5">
                                            <c:set var="head" value="${i*3}" />
                                            <c:set var="tail" value="${head+2}"/>
                                                ...
                                                <li class="row row--${i+1}">
                                                    <ol class="seats" type="A">
                                                        <c:forEach items="${listTripSeatDetail}" var="tripSeatDetail" begin="${head}" end="${tail}">
                                                            <li class="seat">
                                                                <input class="checkbox-seats" type="checkbox" id="36-${tripSeatDetail.seat.seatId}" name="36Seats" value="${tripSeatDetail.seat.seatName}" ${tripSeatDetail.status?"":"disabled"}/>
                                                                <label for="36-${tripSeatDetail.seat.seatId}">${tripSeatDetail.seat.seatName}</label>
                                                            </li>
                                                        </c:forEach>
                                                    </ol>
                                                </li>
        ...
        <script type="text/javascript">
            ...
            let checkboxes = document.querySelectorAll(".checkbox-seats");
            ...
            for (let i = 0; i < checkboxes.length; i++) {
                checkboxes[i].addEventListener('click', function () {
                    if (checkboxes[i].checked === true) {
                        count++;
                        price = count * ${tripDetail.ticketPrice};
                    } else {
                        count--;
                        price = count * ${tripDetail.ticketPrice};
                    }
                    document.getElementById('count-ticket').innerHTML = count;
