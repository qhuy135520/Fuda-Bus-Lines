...
<html>
    ...
    <body>
        ...
        String emailCut = c.getCustomerEmail().substring(0,3);
        session.setAttribute("emailCut",emailCut);
        %>
        <div class="main-content">
            <div>
                <div class="header header-content   d-flex align-items-center" style="width: 100%; background-image: url(img/bus-introduce.jpg); background-repeat: no-repeat; ">
                    <!-- Mask -->
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3 order-lg-2">
                                        <div class="card-profile-image">
                                            <c:if test="${sessionScope.customer.customerUrlImg != null}">
                                                <a href="#">
                                            ...
                                            <c:if test="${sessionScope.customer.customerUrlImg == null}">
                                                <a href="#">
                                                    <img src="img/customer/img-profile-none-bg.png" class="rounded-circle">
                                                </a>
                                            </c:if>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        ...
                                                        <input name="phone" readonly type="text"  class="form-control form-control-alternative" placeholder="phone" value="${sessionScope.customer.customerPhone}" required pattern="[0]{1}[0-9]{9}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-email">Email address</label>
                                                        <input name="email" type="email" readonly  class="form-control form-control-alternative" placeholder="${sessionScope.emailCut}***********@gmail.com">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        ...
                                                        <input name="firstname" type="text"  class="form-control form-control-alternative" placeholder="First name" value="${sessionScope.customer.customerFirstname}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        <label class="form-control-label" for="input-last-name">Last name</label>
                                                        <input name="lastname" type="text"  class="form-control form-control-alternative" placeholder="Last name" value="${sessionScope.customer.customerLastname}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        ...
                                                        <input name="birthdate" type="date" class="form-control form-control-alternative" placeholder="YYYY/MM/DD" value="${sessionScope.customer.customerBirthdate}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        <label class="form-control-label" for="input-country">Created date</label>
                                                        <input name="created-date" type="date" readonly="" class="form-control form-control-alternative" placeholder="YYYY/MM/DD" value="${sessionScope.customer.customerCreatedDate}">
                                                    </div>
                                                </div>
                                                <div class="d-grid gap-2">
                                                    <button type="submit" class="btn btn-primary submit-edit-profile" type="button">Edit profile</button>
                                                </div>
                                                <hr class="my-4">
                                                <div class="d-grid gap-2">
                                                    <button onclick="window.location = 'EditProfileEmailVerification.jsp'" class="btn btn-primary submit-edit-profile" type="button">Change Password</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body modal-body-file">
                                <div class="profile-pic-div">
                                    <img src="${sessionScope.customer.customerUrlImg}" id="photo" />
