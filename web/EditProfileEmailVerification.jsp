                    ...
                    <div class="col-xl-8 order-xl-1">
                        <div class="card bg-secondary shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pl-lg-4">
                                    <form action="EditProfileVerifyCodeServlet" method="GET">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group focused">
                                                    <label class="form-control-label" for="input-city">Email verification &nbsp;&nbsp;&nbsp; <span style="color: red">${editEmailVerificationError} </span></label>
