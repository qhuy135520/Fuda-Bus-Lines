                    ...
                    <div class="col-xl-8 order-xl-1">
                        <div class="card bg-secondary shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pl-lg-4">
                                    <form action="EditProfileVerifyCodeServlet" method="POST">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group focused">
                                                    <label class="form-control-label" for="input-city">Code verification &nbsp;&nbsp;&nbsp; <span style="color: red">${editProfileCodeError} </span></label>
                                                    <input name="code" type="text" id="code" class="form-control form-control-alternative" required  />
                                                </div>
                                            </div>
                                            <div class="d-grid gap-2">
                                                <button type="submit" class="btn btn-primary submit-edit-profile" type="button">Confirm</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
