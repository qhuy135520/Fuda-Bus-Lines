                ...
                <c:if test="${bookingDetailDTOList !=null}">
                    ...
                    <nav aria-label="" style="margin-top: 15px;">
                        <ul class="pagination justify-content-center">
                            ...
                            <c:if test="${page != 1}">
                                <li class="page-item">
                                    <a class="page-link" href="ListRefundingServlet?page=${page-1}">Previous</a>
                                </li>
                            </c:if>
                            <c:if test="${page == 1}">
                            ...
                            <c:forEach var="i" begin="1" end="${endPage}">
                                <c:if test="${page == i}">
                                    <li class="page-item active">
                                        <a class="page-link" href="ListRefundingServlet?page=${i}">${i}</a>
                                    </li>
                                </c:if>
                                <c:if test="${page != i}">
                                    <li class="page-item ">
                            ...
                            <c:if test="${endPage != page}">
                                <li class="page-item">
                                    <a class="page-link" href="ListRefundingServlet?page=${page+1}">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</a>
                                </li>
                            </c:if>
                            <c:if test="${endPage == page}">
                                <li class="page-item disabled">
                    ...
                    <c:forEach items="${bookingDetailDTOList}" var="bookingDetailDTO">
                        <c:if test="${bookingDetailDTO.booking.code != null}">
                            <div class="modal fade" id="refund${bookingDetailDTO.booking.bookingId}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Make sure you want to "<span style="color: red">Refund</span>" for this customer "<span style="color: red">${bookingDetailDTO.booking.customer.customerFirstname} ${bookingDetailDTO.booking.customer.customerLastname}</span>"
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-success" onclick="window.location = 'EmployeeRefundCustomerServlet?bookingId=${bookingDetailDTO.booking.bookingId}'">Refund</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="refund${bookingDetailDTO.booking.bookingId}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Make sure you want to "<span style="color: red">Cancel</span>" for this customer "<span style="color: red">${bookingDetailDTO.booking.customer.customerFirstname} ${bookingDetailDTO.booking.customer.customerLastname}</span>"
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
