        ...
        <div class="container-pay" style="margin-top:100px; ">
            ...
            <div class="table-responsive">
                <form action="vnpayajax" id="frmCreateOrder" method="post">        
                    ...
                    <div class="form-group">
                        <div class="card">
                            <div class="card-body input-language">
                    ...
                    <div class="form-group">
                        ...
                        <div class="card">
                            <div class="card-body row input-language d-flex justify-content-between">
                                <div class="col-md-4 ">
                                    <ul>
                                        <li>
                        ...
                        <div class="d-flex justify-content-center"> 
                            <button type="submit" class="btn btn-danger btn-pay" href>Thanh toán</button>
                        </div>
                </form>
            </div>
        </div>
